                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="brand_logo" class="form-label">Update Brand Logo</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <img id="preview" class="rounded" width="200" src="data:image/jpeg;base64,{{ base64_encode($brand->brand_logo)}}" alt="Preview Brand Logo" style="display: block; border: 1px solid #ccc; padding: 5px;">
                                            </div>
                                        </div>
                                    </div>
