                    ...
                    <tbody>
                        @foreach ($brand as $item)
                            <tr>
                                ...
                                <td>{{ $item->brand_name }} - {{ $item->brand_id }}</td>
                                <td><img src="{{ asset('storage/gambarStorage/' . $item->brand_logo) }}"
                                        alt="" style="width: 200px"></td>
                                <td>
                                    <a href="/brand/edit/{{ $item->brand_id }}" class="btn btn-success">Edit</a>
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                        data-bs-target="#modalHapus{{ $item->brand_id }}">
                                        Hapus - {{ $item->brand_id }}
                                    </button>
                                    <div class="modal fade" id="modalHapus{{ $item->brand_id }}" tabindex="-1"
