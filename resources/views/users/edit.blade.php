                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" name="phone_number" id="phone_number" value="{{ $user->phone_number }}" required>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    ...
                                                    @if($user->profile_picture)
                                                        <img src="data:image/jpeg;base64,{{ base64_encode($user->profile_picture) }}" alt="Profile Picture" class="img-thumbnail mt-3" width="100">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
